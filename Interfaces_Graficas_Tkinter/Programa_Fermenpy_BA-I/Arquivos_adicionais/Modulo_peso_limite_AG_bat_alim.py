...
def limites():
    limites_Monod = [(0, 1),(0, 100),(0, 1),(0, 1),(0, 10),(0, 1)] #6
    limites_Contois = [(0, 1),(0, 100),(0, 1),(0, 1),(0, 100),(0, 100)] #6
    limites_Moser = [(0, 1),(5, 10),(0, 1),(0.01, 1),(0, 10),(0, 1),(1,2)] #7
    limites_Andrews = [(0, 1),(0, 100),(0, 1),(0.01, 1),(0, 100),(0, 100),(1, 45)] #7
    limites_Hope_Hansford = [(0, 1),(0, 100),(0, 1),(0, 1),(0, 100),(0, 100),(0,100)]#7
    limites_Aiba = [(0, 1),(0, 100),(0, 1),(0, 1),(0, 100),(0, 100),(0.1,2)] #7
    limites_Wu = [(0, 1),(0, 5),(0, 1),(0.01, 10),(0, 10),(0, 10),(1,25),(1,2)]#8
    limites_Levenspiel = [(0, 1),(0, 100),(0, 1),(0.01, 1),(0, 10),(0, 1),(0,3),(1,50)]#8
    limites_Lee = [(0, 1),(0, 100),(0, 1),(0.01, 1),(0, 10),(0, 1),(0,3),(1,57)]#8
    limites_mi_const = [(0, 3),(0, 1),(0, 1),(0, 7),(0, 5), (0, 1)]#6
