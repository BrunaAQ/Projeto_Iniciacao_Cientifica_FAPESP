...
Ks = 2
## Entrada para o adimensional potência inibição celular m:
m = 2
## Entrada para a concentração celular crítica Cx_estr:
Cx_estr = 43
...
## Cálculo mi:
mi = mimaximo*((concentotals/(Ks+concentotals))*((abs(1-(concentotalx/Cx_estr)))**m))
...
### Função Q(t) original:
Q_calc = np.repeat(Q, len(t_total_ba))
