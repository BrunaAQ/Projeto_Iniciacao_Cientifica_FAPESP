...
Ks = 2
##Entrada para o termo expoente adimensional:
n = 1.5
##Entrada para a concentração de produto crítica:
Cp_estr = 15
...
## Cálculo mi:
mi = mimaximo*((concentotals/(Ks+concentotals))*((abs(1-(concentotalp/Cp_estr)))**n))
