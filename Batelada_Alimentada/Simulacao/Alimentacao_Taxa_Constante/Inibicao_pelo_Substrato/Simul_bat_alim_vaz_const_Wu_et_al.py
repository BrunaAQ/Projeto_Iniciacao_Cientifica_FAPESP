...
Ks = 2
##Entrada para o termo expoente adimensional v:
v = 1
##Entrada para a constante de inibição pelo substrato KE:
KE = 25
...
## Cálculo mi:
mi = mimaximo * (concentotals/(Ks + concentotals + concentotals*((concentotals/KE)**v)))
