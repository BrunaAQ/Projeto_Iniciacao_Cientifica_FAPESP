# -*- coding: utf-8 -*-
"""
Created on Sun Jan  3 12:35:44 2021
...
def entr_Contois():
    def entr_val_Contois():
        ...
        KSX = 3.1 #3.14 #unidade g/L - constante de semi-saturação
        ...
        Q0_exp = 0.252
        beta_exp = 0.1
        return(mimaximo,KSX,Kd,Cx0_bat,Cs0_bat,Cp0_bat,tf_bat,Yxs,alfa,beta, Cs0_alim, tf_alim, V0, Vf, Q, Q0, a, Q0_exp, beta_exp)
    mimaximo, KSX, Kd, Cx0_bat, Cs0_bat, Cp0_bat, tf_bat, Yxs, alfa, beta, Cs0_alim, tf_alim, V0, Vf, Q, Q0, a, Q0_exp, beta_exp = entr_val_Contois()
    entr_val_bat = [mimaximo, KSX, Kd, Cx0_bat, Cs0_bat, Cp0_bat, tf_bat, Yxs, alfa, beta]
...
# Função 2)
def modelag_Contois_dados_conc_sim():
