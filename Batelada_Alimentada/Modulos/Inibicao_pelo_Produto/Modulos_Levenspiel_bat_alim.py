# -*- coding: utf-8 -*-
"""
Created on Thu Nov 12 17:02:42 2020

@author: Bruna Aparecida
"""
                     # MODELO CINÉTICO DE CRESCIMENTO MICROBIANO COM INIBIÇÃO - LEVENSPIEL #
...
def entr_Levenspiel():
    def entr_val_Levenspiel():
        ...
        beta =  0.02 #0 # unidade g produto/g células . h - coeficiente estequiométrico
        n = 0.2
        Cp_estr = 10
        Cs0_alim = 150 #500
        tf_alim = 35
        ...
        Q0_exp = 0.252
        beta_exp = 0.5
        return(mimaximo,Ks,Kd,Cx0_bat,Cs0_bat,Cp0_bat,tf_bat,Yxs,alfa,beta, n, Cp_estr, Cs0_alim, tf_alim, V0, Vf, Q, Q0, a, Q0_exp, beta_exp)
    mimaximo, Ks, Kd, Cx0_bat, Cs0_bat, Cp0_bat, tf_bat, Yxs, alfa, beta, n, Cp_estr, Cs0_alim, tf_alim, V0, Vf, Q, Q0, a, Q0_exp, beta_exp = entr_val_Levenspiel()
    entr_val_bat = [mimaximo, Ks, Kd, Cx0_bat, Cs0_bat, Cp0_bat, tf_bat, Yxs, alfa, beta, n, Cp_estr]
...
# Função 2)
def modelag_Levenspiel_dados_conc_sim():
