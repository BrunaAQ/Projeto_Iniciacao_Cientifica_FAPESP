# -*- coding: utf-8 -*-
"""
Created on Fri Nov 13 10:27:05 2020

@author: Bruna Aparecida
"""

                     # MODELO CINÉTICO DE CRESCIMENTO MICROBIANO COM INIBIÇÃO - LEE ET AL #
...
def entr_Lee_et_al():
    def entr_val_Lee_et_al():
        ...
        Q0_exp = 0.252
        beta_exp = 0.1
        return(mimaximo,Ks,Kd,Cx0_bat,Cs0_bat,Cp0_bat,tf_bat,Yxs,alfa,beta, m, Cx_estr, Cs0_alim, tf_alim, V0, Vf, Q, Q0, a, Q0_exp, beta_exp)
    mimaximo, Ks, Kd, Cx0_bat, Cs0_bat, Cp0_bat, tf_bat, Yxs, alfa, beta, m, Cx_estr, Cs0_alim, tf_alim, V0, Vf, Q, Q0, a, Q0_exp, beta_exp = entr_val_Lee_et_al()
    entr_val_bat = [mimaximo, Ks, Kd, Cx0_bat, Cs0_bat, Cp0_bat, tf_bat, Yxs, alfa, beta, m, Cx_estr]
...
# Função 2)
def modelag_Lee_et_al_dados_conc_sim():
