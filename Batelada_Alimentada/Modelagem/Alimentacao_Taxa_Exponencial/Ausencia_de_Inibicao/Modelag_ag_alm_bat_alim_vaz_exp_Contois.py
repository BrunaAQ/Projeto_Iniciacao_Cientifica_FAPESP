# -*- coding: utf-8 -*-
"""
Created on Thu Nov 19 10:48:03 2020

@author: Bruna Aparecida
"""
                    ## MODELAGEM BATELADA ALIMENTADA À VAZÃO EXPONENCIAL CINÉTICA DE CONTOIS ##
...
KSX_otim = resultado_alm_alim[0][1]

mi_exp = mimaximo_otim*(Cs_exp/((KSX_otim*Cx_exp) + Cs_exp))
mi_exp[mi_exp<0] = 0
mi = mimaximo_otim*(Cs/((KSX_otim*Cx) + Cs))
mi[mi<0] = 0
