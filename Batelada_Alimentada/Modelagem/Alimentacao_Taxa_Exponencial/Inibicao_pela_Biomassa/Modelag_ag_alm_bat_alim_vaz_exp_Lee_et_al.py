# -*- coding: utf-8 -*-
"""
Created on Thu Nov 26 14:53:28 2020

@author: Bruna Aparecida
"""

                    ## MODELAGEM BATELADA ALIMENTADA À VAZÃO EXPONENCIAL CINÉTICA DE LEE ET AL ##
...
print("Cx_estr_bat:",resultado_alm_bat[0][6])#,"+/-",ICpar_bat[6],"[gx/l]")
#*ETAPA 2*#
...
print("m_alim:",resultado_alm_alim[0][5])#"+/-",ICpar_bat[5],"[adimensional]")
print("Cx_estr_bat:",resultado_alm_bat[0][6])#,"+/-",ICpar_bat[6],"[gx/l]")
...
_ = lns6 = ax2.plot(Ttotal_exp,Cp_exp,'s',color = "green", markersize = 6,label = 'Cp experimental')
