...
import Modulos_Aiba_et_al_bat_alim_sem_Kd
...
dad_entr_geral = Modulos_Aiba_et_al_bat_alim_sem_Kd.entr_Aiba_et_al()
...
func_args_bat = Modulos_Aiba_et_al_bat_alim_sem_Kd.modelag_bat_Aiba_et_al_func_args()
