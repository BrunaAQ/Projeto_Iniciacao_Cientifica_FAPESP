...
for ContadorCs in range(len(Ttotal)):
    if (concentotals[ContadorCs]<0):
        concentotals[ContadorCs]=0
        concentotalx[ContadorCs]=concentotalx[ContadorCs-1]
        concentotalp[ContadorCs]=concentotalp[ContadorCs-1]
...
## Cálculo mi:
mi = np.repeat(mi_entr,len(Ttotal))
