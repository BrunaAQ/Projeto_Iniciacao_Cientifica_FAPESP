...
def entr_rand_Moser():
    def entr_rand_Moser_gerand():
        mimaximo = 0.35 # unidade 1/hora - taxa específica de crescimento
        ...
        alfa = 0.14 # unidade g células/g produto - coeficiente estequiométrico
        ...
        mi_exp_4 = 1.6
        mi_exp_5 = 1.8
        return(mimaximo, Ks, Kd, Cx0, Cs0, Cp0, tf, Yxs, alfa, beta, mi_exp_1, mi_exp_2, mi_exp_3, mi_exp_4, mi_exp_5)
    mimaximo, Ks, Kd, Cx0, Cs0, Cp0, tf, Yxs, alfa, beta, mi_exp_1, mi_exp_2, mi_exp_3, mi_exp_4, mi_exp_5 = entr_rand_Moser_gerand()
    entr_rand_val = [mimaximo, Ks, Kd, Cx0, Cs0, Cp0, tf, Yxs, alfa, beta, mi_exp_1, mi_exp_2, mi_exp_3, mi_exp_4, mi_exp_5]
...
def modelag_bat_Moser_dados_conc_sim():
   importado = pd.read_excel("Dados_entrada_bat_Moser_modelagem_01.xlsx","C_exp") 
...
def modelag_bat_Moser_func_args():
    def bat_Moser(C, t, *args):
        ...
        mi=mimaximo*(((C[1])**mi_exp)/(Ks+((C[1])**mi_exp)))
        dCxdt=(mi-Kd)*C[0]
        dCsdt=(-1/Yxs)*mi*C[0]
